...
- **Nur Metropolis-Akzeptanz**: wie bei [parallel-tempering-demo](../parallel-tempering-demo) literaturtreu (Ropke & Pisinger 2006 selbst nutzen dieselbe Regel), nicht willkürlich.
